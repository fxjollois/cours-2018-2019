...
Une fois sauvegardé dans **R Studio**, vous devez voir apparaître en haut à droite du code source, une flèche verte avec le texte  `Run App`, qui vous permettra d'exécuter l'application. Vous pouvez tester le rendu à obtenir en lançant la commande suivante.

```{r}
runGist("https://gist.github.com/fxjollois/ac4edcb0e93e57baed6f64a626cab872")
```
